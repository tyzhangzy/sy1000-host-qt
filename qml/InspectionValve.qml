...
Rectangle {
    ...
    Column {
        ...
        Row {
            ...
            TextField { id: valNo; width: 220; height: 40; Material.background: "transparent"; Material.variant: Material.Text; padding: 4
            ...
            TextField { id: valThreadCond; width: 220; height: 40; Material.background: "transparent"; Material.variant: Material.Text; padding: 4
                Rectangle { anchors.left: parent.left; anchors.right: parent.right; anchors.bottom: parent.bottom; height: 1; color: "#9E9E9E" }
            }
        }
